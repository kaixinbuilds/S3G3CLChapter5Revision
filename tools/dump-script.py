...
w("")
w("成绩单显示：姓名、班级、三关的**首次**与**最好**成绩、各关用时与总用时、")
w("总分 /%d、完成日期与时间、验证码。" % TOTAL)
w("")
w("> **首次那一栏是给老师看的。**送进 SLS 的是重做后最好的一次；首次成绩只印在凭证上。")
w("> 两个数字一样就淡下去，不一样才亮起来 —— 扫一眼就知道哪一关是磨出来的。")
w("> 例：`第二关　首次 3/12　最好 12/12`。")
w("")
w("### 还差一点（未达 %d 分）" % PASS)
w("")
